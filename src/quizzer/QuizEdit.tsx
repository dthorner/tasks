...
export const QuizEdit = ({
    ...
    const editQuestion = (questionId: number, newQuestion: Question) => {
        setNewQuiz({
            ...newQuiz,
            questionList: newQuiz.questionList.map((q: Question): Question => {
                return q.id === questionId ? { ...newQuestion } : { ...q };
            })
        });
    };
                    ...
                    <div className="title_published_flex">
                        ...
                        <Form.Check
                            ...
                            onChange={() => {
                                ...
                                setNewQuiz({
                                    ...newQuiz,
                                    published: !newQuiz.published //come back to this
                                });
                            }}
                        ></Form.Check>
                    </div>
